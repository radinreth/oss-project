...
<div id="contain-wrapper">
    ...
    <section id="contain-body">
        	<div id="l_c_body">
            	<div id="l_c_left">
       	    <div id="l_c_contract">
                    	<div id="l_c_photo"><img src="../images/company_logo/<?php echo $commpany["com_logo"];?>" width="79" height="77" /></div>
...
<input type="text" class="text_box" id="longitude" name="longitude" value="<?php echo (($company['longitued']!='')?$company['longitued']:'104.92080688476562'); ?>" style="display:none;">
  ...
  <tr>
    <td>GoChat is the best way to improve your Company...!</td>
           	    ...
           	    <div class="l_c_news">
                        ...
                        <div class="l_c_text">
                          ...
                          <div class="l_c_letter">
                            <img src="../images/promotion/<?php echo $result['prm_image'];?>" width="292" height="90"/>
                          </div>
        ...
        <div id="l_c_comment">
			<div class="fb-comments" data-href="http://example.com/comments" data-width="1150px" data-numposts="5" data-colorscheme="light"></div>
        </div>
