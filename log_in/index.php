...
<div id="s_content_all">
    ...
    <div id="s_body">
        ...
        <div id="s_form_sign_up">
            ...
            <label style="padding-bottom:10px; float:left;"><input type="text" id="txtemail" name="txtemail" class="txtname_log" placeholder="E-mail" value="simsoboth@gmail.com" /></label>
                <label style="padding-bottom:10px; float:left;"><input type="password" id="txtpassword" name="txtpassword" class="txtname_log" placeholder="Password" value="123" /></label>
                <p>
