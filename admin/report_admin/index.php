...
<script type="text/javascript" language="javascript" src="../js/graph_google.js"></script>
    ...
    <script>
      function printData()
      {
         var divToPrint=document.getElementById("counter_report_s_adm");
         newWin= window.open("");
      ...
      $(document).ready(function(){
        ...
        $("#export-report").click(function(){
          tableToExcel('counter_report_s_adm', 'W3C Example Table');
        });
...
<body>
	...
	<div id="content_s_all_adm">
    	<div id="counter_report_search_adm">
          ...
          <span id="print-report">Print</span>
          <span id="export-report">Export to Excel</span>
        </div>
