	...
	<div id="content_s_all">
      ...
      <div id="counter_report_s_register">
        	<div id="chart_line">
                ...
                <span class="embed_span" onclick="alert('<script type=\'text/javascript\' language=\'javascript\' src=\'http:\/\/ffg-cambo.com\/oss-mekong\/chat_mode\/js\/jquery.min.js\'><\/script>\n<script type=\'text/javascript\' language=\'javascript\' src=\'http:\/\/ffg-cambo.com\/oss-mekong\/chat_mode\/js\/jquery.form.js\'><\/script>\n\n<script type=\'text\/javascript\'>\nvar shop_code = <?php echo $company['com_id'];?>;\n\n(function() {\n\tvar lc = document.createElement(\'script\'); \n\tlc.type = \'text\/javascript\'; \n\tlc.async = true; \n\tlc.src = \'http:\/\/ffg-cambo.com\/oss-mekong\/chat_mode\/js\/box.js\';\n\tvar s = document.getElementsByTagName(\'script\')[0]; \n\ts.parentNode.insertBefore(lc, s); })();\n<\/script>');">
