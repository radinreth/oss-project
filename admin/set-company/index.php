...
<body>
	...
	<div id="content_s_all">
      ...
      <div id="counter_report_s_register">
            ...
            <div id="photo_view" onclick="document.getElementById('com_logo').click();"><img src="../../images/company_logo/<?php echo $company['com_logo']!=''?$company['com_logo']:'company-icon.png';?>" width="100px" height="100px" /></div></label></td>
              </tr>
              <tr>
                <td><label>
