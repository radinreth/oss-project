	...
	<div id="l_body">
    	<div id="l_body_left">
           ...
           <?php 
				  ...
				  ?>
                  <p style="font-size:12px;">You have maximum counter to create, <a href="../account_update/">Upgrade Now</a></p>
                  <?php
			   }
		   }
		   ?>
           ...
           <?php 
				  ...
				  ?>
                  <p style="font-size:10px;">You have maximum counter to create, <a href="../account_update/">Upgrade Now</a></p>
                  <?php
			   }
		   }
		   ?>
           ...
           <?php 
				  ...
				  ?>
                  <p>You have maximum counter to create, <a href="../account_update/">Upgrade Now</a></p>
                  <?php
			   }
		   }
		   ?>
