	...
	<div id="content_s_all">
      ...
      <div id="counter_report_s_register">
            ...
            <div id="show_chart_setcompnay">
            	<div class="text_info" style="font-size:18px;"><strong> The account status</strong>: <?php if($_SESSION['package']==0){echo "Free";}else if($_SESSION['package']==1){echo "Premium";}else{echo "Golden";};?> Account  <p style="color:#F00;">Expired Account</p></div>
